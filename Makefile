...
check-deps:
	@echo "依存関係を確認しています..."
	@for dir in app/api/v1/words app/api/v1/kanjis app/api/v1/learn_words app/api/v1/search app/api/v1/sentences; do \
...
check-structure:
	...
	@for dir in words kanjis learn_words search sentences; do \
