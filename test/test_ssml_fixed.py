...
def test_fixed_ssml():
    """修正されたSSML音声合成をテスト"""
    test_cases = [
        {"name": "修正SSML: 文 + ぶん", "word": "文", "reading": "ぶん", "filename": "test_fixed_ssml_bun.mp3"},
        {"name": "修正SSML: 北 + きた", "word": "北", "reading": "きた", "filename": "test_fixed_ssml_kita.mp3"},
        {
            "name": "修正SSML: 学校 + がっこう",
            "word": "学校",
            "reading": "がっこう",
        ...
        {"name": "比較用: 文のみ", "word": "文", "reading": None, "filename": "test_normal_bun_compare.mp3"},
        {
            "name": "比較用: ぶんのみ",
            "word": "ぶん",
            "reading": None,
