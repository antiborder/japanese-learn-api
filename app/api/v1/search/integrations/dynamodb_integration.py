...
class SearchDynamoDBClient:
    ...
    def _search_by_name(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                ExpressionAttributeValues={":name": query, ":pk": "WORD"},
            )
    ...
    def _search_by_english(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#english": "english"},
                ExpressionAttributeValues={":english": query, ":pk": "WORD"},
            )
    ...
    def _search_by_vietnamese(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#vietnamese": "vietnamese"},
                ExpressionAttributeValues={":vietnamese": query, ":pk": "WORD"},
            )
    ...
    def _search_by_chinese(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#chinese": "chinese"},
                ExpressionAttributeValues={":chinese": query, ":pk": "WORD"},
            )
    ...
    def _search_by_korean(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#korean": "korean"},
                ExpressionAttributeValues={":korean": query, ":pk": "WORD"},
            )
    ...
    def _search_by_indonesian(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#indonesian": "indonesian"},
                ExpressionAttributeValues={":indonesian": query, ":pk": "WORD"},
            )
    ...
    def _search_by_hindi(self, query: str) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#hindi": "hindi"},
                ExpressionAttributeValues={":hindi": query, ":pk": "WORD"},
            )
    ...
    def search_kanjis(self, query: str, limit: int = 20, offset: int = 0) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                ExpressionAttributeValues={":character": query, ":pk": "KANJI"},
            )
    ...
    def search_components(self, query: str, limit: int = 20, offset: int = 0) -> List[Dict]:
        ...
        try:
            response = self.table.query(
                ...
                FilterExpression="PK = :pk",
                ExpressionAttributeNames={"#character": "character"},
                ExpressionAttributeValues={":character": query, ":pk": "COMPONENT"},
            )
    ...
    def _convert_component_dynamodb_to_model(self, item: Dict) -> Dict:
        ...
        """
        return {"id": int(item["SK"]), "character": item.get("character", "")}
