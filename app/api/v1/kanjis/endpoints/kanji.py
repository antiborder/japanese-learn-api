...
async def fetch_kanji_ai_description(
    kanji_id: int, lang: Optional[str] = Query(default="en", description="言語コード (en, vi, zh-Hans, hi, etc.)")
):
    """
    ...
    try:
        ...
        return KanjiAIDescriptionResponse(
            kanji_id=kanji_id, kanji_character=kanji_character, language=lang, description=description_text
        )
