...
def lambda_handler(event, context):
    try:
        ...
        if http_method == "OPTIONS":
            ...
            logger.info(
                f"OPTIONS request received. Origin: {event.get('headers', {}).get('origin') or event.get('headers', {}).get('Origin')}, Allowed: {allowed_origin}"
            )
            ...
            if allowed_origin:
                ...
                logger.warning("Origin not allowed. No CORS headers will be returned.")
