...
class RAGService:
    ...
    def initialize(self):
        ...
        if not self.vector_store.load_from_s3():
            ...
            logger.warning(
                "WARNING: This will take a long time if you have many items. Consider building the index first with: python scripts/build_faiss_index.py"
            )
    ...
    def search_all(self, query: str, k: int = 5) -> Dict[str, List[Dict]]:
        ...
        return {"words": words, "kanjis": kanjis}
